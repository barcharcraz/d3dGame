...
namespace Components {
	Velocity3D::Velocity3D(const Eigen::Vector4f& lin, const Eigen::Quaternionf& rot)
		: linear(lin), angular(rot) {}
	Velocity3D::Velocity3D(const Eigen::Affine3f& trans)
		: Velocity3D(trans.translation(), Eigen::Quaternionf(trans.rotation())) {}
	Velocity3D::Velocity3D(const Eigen::Vector4f& lin)
		: Velocity3D(lin, Eigen::Quaternionf::Identity()) {}
	Velocity3D::Velocity3D(const Eigen::Quaternionf& rot)
		: Velocity3D(Eigen::Vector4f::Identity(), rot) {}

	PremulVelocity3D::PremulVelocity3D(const Eigen::Vector4f& lin, const Eigen::Quaternionf& rot)
		: linear(lin), angular(rot) {}
